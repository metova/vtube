...
public class EulaManager extends ScrollingDescriptionManager {

    private RichTextField richTextField;

    protected void onInitialize() {

        String eula = MobileResources.instance().getResourceAsString( "/eula.txt.gz" );
        setRichTextField( new RichTextField( eula, NON_FOCUSABLE ) );
    }
