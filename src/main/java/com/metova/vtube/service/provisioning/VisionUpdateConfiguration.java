...
import com.metova.bb.provisioning.model.update.UpdateServiceConfiguration;

public class VisionUpdateConfiguration extends UpdateServiceConfiguration implements Persistable {

    public VisionUpdateConfiguration() {

        setEnabled( true );
        setNotifyType( NOTIFY_TYPE_ONCE );
        ...
        setUrl( operationUrl + "rs/provisioning/application/" + MobileApplication.instance().getModuleName() + "/latestVersion" );
    }
}
