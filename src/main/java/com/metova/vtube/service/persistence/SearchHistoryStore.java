...
public class SearchHistoryStore extends AbstractStore {

    private static SearchHistoryStore myself;

    public static SearchHistoryStore instance() {
    ...
    private SearchHistoryStore() {
        ...
        super( PersistableVector.class, UID.SEARCH_HISTORY_STORE );
    }
